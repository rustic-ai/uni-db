...
**Generated:** 2026-02-17 22:12:53
**Results:** `results_20260217_221253.json`
**Compared to:** `results_20260217_211234.json`
...
| ❌ WithOrderBy2 | 83 | 35 | 48 | 42% | +6pp |
| ⚠️ WithOrderBy3 | 93 | 69 | 24 | 74% | +4pp |
...
- **WithOrderBy2** — [1] Sort by a boolean expression in ascending order (line 61)
- **WithOrderBy2** — [1] Sort by a boolean expression in ascending order (line 62)
- **WithOrderBy2** — [1] Sort by a boolean expression in ascending order (line 63)
- **WithOrderBy2** — [2] Sort by a boolean expression in descending order (line 92)
- **WithOrderBy2** — [2] Sort by a boolean expression in descending order (line 93)
- **WithOrderBy3** — [5] An expression without explicit sort direction is sorted in ascending order (line 204)
- **WithOrderBy3** — [5] An expression without explicit sort direction is sorted in ascending order (line 205)
- **WithOrderBy3** — [5] An expression without explicit sort direction is sorted in ascending order (line 206)
- **WithOrderBy3** — [5] An expression without explicit sort direction is sorted in ascending order (line 207)
...
- **[6] Should provide accessors for date time** (line 119)
  ...
  Step failed:
      ...
      Matched: crates/uni-tck/src/steps/then.rs:20:1
      Step panicked. Captured output: Result mismatch (any order): No match found for actual row 0. Actual values: [("d.second", Some(Int(14))), ("d.dayOfQuarter
  ... (truncated)
  ```
