...
mod create_tests {
    ...
    async fn test_create_vertex_label_ordering_independence() -> Result<()> {
        ...
        props_b.insert("name".to_string(), json!("Alice"));
...
mod read_tests {
    ...
    async fn test_query_by_single_label() -> Result<()> {
        ...
        props_c.insert("name".to_string(), json!("Charlie"));
        writer
            .insert_vertex_with_labels(
                vid_c,
                props_c,
...
mod update_tests {
    ...
    async fn test_update_properties_preserves_labels() -> Result<()> {
        ...
        // Update properties
        let mut props2 = HashMap::new();
        props2.insert("name".to_string(), json!("Alicia"));
        props2.insert("age".to_string(), json!(31));
        writer
            .insert_vertex_with_labels(
                vid,
                props2,
...
mod delete_tests {
    ...
    async fn test_delete_and_recreate() -> Result<()> {
        ...
        let mut props2 = HashMap::new();
        props2.insert("name".to_string(), json!("Alice"));
        writer
            .insert_vertex_with_labels(
                vid,
                props2,
    ...
    async fn test_detach_delete_multi_label() -> Result<()> {
        ...
        props_person.insert("name".to_string(), json!("Alice"));
        writer
            .insert_vertex_with_labels(
                vid_person,
                props_person,
        ...
        props_company.insert("name".to_string(), json!("ACME Corp"));
        writer
...
mod index_tests {
    ...
    async fn test_bidirectional_consistency() -> Result<()> {
        ...
        for (vid, labels) in vids.iter().zip(label_combinations.iter()) {
            let mut props = HashMap::new();
            props.insert("name".to_string(), json!(format!("Person{}", vid.as_u64())));
            writer
